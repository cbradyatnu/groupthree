  ...
  [
   ...
   [
     ...
     [ ;sound:play-note "TRUMPET" 60 64 1
       carefully [run hubnet-message]
       [ show error-message ]
       ;it's not either an enter or exit message...
       ;for this model, we'll just show what the message contains...
...
468
SEND THIS
send-data-to client-name widget-name widget-value
NIL
1
T
OBSERVER
...
468
SEND NUMERIC
hubnet-send client-name widget-name number-value
NIL
1
T
OBSERVER
...
468
SEND BOOLEAN
hubnet-send client-name widget-name boolean-value
NIL
1
T
OBSERVER
